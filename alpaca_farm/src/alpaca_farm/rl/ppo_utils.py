...
class TrainingArguments(transformers.TrainingArguments):
    wandb_project: str = field(default="lnf")
    ...
    policy_lora_path: str = field(default=None)
    ...
    latest_checkpoint_path: str = field(default=None)
    kl_term_variant: str = field(default="alpaca_farm")
    use_lora: bool = field(default=False)
    lora_r: int = field(default=8)
    lora_alpha: int = field(default=64)
    lora_dropout: float = field(default=0.1)
    kl_analysis: bool = field(default=False)
