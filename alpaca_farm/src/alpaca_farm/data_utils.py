...
from .data_preprocessor import (
    ...
    DataCollatorForNotStackableDataset,
    QueryDataset,
    SFTDataset,
...
def make_binary_reward_modeling_data_module(
    ...
    if "preference" in alpaca_human_preference:
        train_df = pd.DataFrame(alpaca_human_preference["preference"])
    else:
        train_df = pd.concat([pd.DataFrame(alpaca_human_preference[split]) for split in data_args.train_splits])
